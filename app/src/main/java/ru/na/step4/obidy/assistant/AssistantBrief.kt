 ...
 * А (список) → Б (ситуация + чувства + действия + вопросы 1–4) →
 * В (вопросы 5–13) → закрытие со спонсором.
 */
object AssistantBrief {
    const val APP_NAME = "4 \u0448\u0430\u0433 \u00b7 \u041e\u0431\u0438\u0434\u044b"

    const val FIRST_MESSAGE =
        "\u042f\u0020\u0440\u044f\u0434\u043e\u002c\u0020\u0447\u0442\u043e\u0431\u044b\u0020\u043f\u043e\u043c\u043e\u0447\u044c\u0020\u0440\u0430\u0437\u043e\u0431\u0440\u0430\u0442\u044c\u0020\u043e\u0431\u0438\u0434\u0443\u0020\u043f\u043e\u0020\u043f\u0443\u043d\u043a\u0442\u0430\u043c\u0020\u0410\u2013\u0412\u0020\u0438\u0020\u0031\u0033\u0020\u0432\u043e\u043f\u0440\u043e\u0441\u0430\u043c\u002e\u0020\u0425\u043e\u0442\u0438\u0442\u0435\u0020\u043d\u0430\u0447\u0430\u0442\u044c\u0020\u043d\u043e\u0432\u0443\u044e\u0020\u043e\u0431\u0438\u0434\u0443\u0020\u0438\u043b\u0438\u0020\u043f\u0440\u043e\u0434\u043e\u043b\u0436\u0438\u0442\u044c\u003f"
...
Цель: помочь заполнить инвентарь обид по методичке АН (стримы про resentment): пункты А, Б, В и 13 вопросов.
...
Структура работы:
А) Кому/чему обижен (человек, учреждение, концепция). Сначала только имя — без детальной ситуации.
Б) После цели уточни тип ситуации. Затем для одной ситуации: что произошло; я чувствовал; я делал. Затем вопросы 1–4 (гордость, безопасность/благополучие, личные отношения, желания/конфликт).
В) Вопросы 5–13 (жадность/вожделение, крайности, манипуляции, эгоцентризм, «жизнь должна», ожидания, гордыня, страх, непрожитые чувства).
В конце — напомнить сохранить в приложении и разобрать со спонсором. Вопросы 14–15 и «справедливые обиды» — позже, одной сессией на весь список.
