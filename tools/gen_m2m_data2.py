...
# AppDatabase - read current and rewrite with v5
w(
    "data/AppDatabase.kt",
    r'''package ru.na.step4.obidy.data
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL(
                    ...
                    CREATE TABLE IF NOT EXISTS situation_type_links (
                        ...
                        FOREIGN KEY(situationId) REFERENCES situations_new(id) ON DELETE CASCADE,
                        FOREIGN KEY(typeId) REFERENCES situation_types(id) ON DELETE CASCADE
                    )
                    """.trimIndent()
                )
